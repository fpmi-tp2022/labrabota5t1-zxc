...
namespace zxc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("3 - according to the type of product that is in the greatest demand.");
            Console.WriteLine("4 - brokers who have made the maximum number of transactions - information \nabout him and supplier firms.");
            Console.WriteLine("5 - for each supplying company - a list of brokers with information on the \nquantity and cost of goods sold by them for each broker.");
